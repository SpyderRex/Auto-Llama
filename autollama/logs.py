...
class Logger(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        console_formatter = AutoLlamaFormatter("%(title_color)s %(message)s")
        ...
        info_formatter = AutoLlamaFormatter(
        ...
        error_formatter = AutoLlamaFormatter(
...
class AutoLlamaFormatter(logging.Formatter):
    """
