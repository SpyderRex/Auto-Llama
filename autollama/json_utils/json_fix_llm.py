"""This module contains functions to fix JSON strings generated by LLM models, such as Llama3, using the assistance
of the Groq API or LLM models."""
...
from autollama.json_utils.json_fix_general import correct_json
...
def auto_fix_json(json_string: str, schema: str) -> str:
    """Fix the given JSON string to make it parseable and fully compliant with
        the provided schema using Llama3.
    ...
    """
    # Try to fix the JSON using Llama:
...
def fix_json_using_multiple_techniques(assistant_reply: str) -> Dict[Any, Any]:
    ...
    if CFG.speak_mode:
        say_text("I have received an invalid JSON response from the Groq API.")

    return {}


def fix_and_parse_json(
    json_to_load: str, try_to_fix_with_llama: bool = True
) -> Dict[Any, Any]:
    """Fix and parse JSON string

    Args:
        json_to_load (str): The JSON string.
        try_to_fix_with_llama (bool, optional): Try to fix the JSON with Llama.
            Defaults to True.
    ...
    # sometimes Llama responds with something BEFORE the braces:
    ...
    try:
        ...
        return try_ai_fix(try_to_fix_with_llama, e, json_to_load)


def try_ai_fix(
    try_to_fix_with_llama: bool, exception: Exception, json_to_load: str
) -> Dict[Any, Any]:
    """Try to fix the JSON with the AI

    Args:
        try_to_fix_with_llama (bool): Whether to try to fix the JSON with the AI.
        exception (Exception): The exception that was raised.
        json_to_load (str): The JSON string to load.

    Raises:
        exception: If try_to_fix_with_llama is False.

    Returns:
        str or dict[Any, Any]: The JSON string or dictionary.
    """
    if not try_to_fix_with_llama:
        raise exception
    if CFG.debug_mode:
        logger.warn(
...
def attempt_to_fix_json_by_finding_outermost_brackets(json_string: str):
    if CFG.speak_mode and CFG.debug_mode:
        say_text(
            "I have received an invalid JSON response from the Groq API. "
