...
def benchmark_entrepreneur_llama_with_difficult_user():
...
Not what I need."""
    ...
    command = [sys.executable, "-m", "autollama"]
...
if __name__ == "__main__":
    benchmark_entrepreneur_llama_with_difficult_user()
